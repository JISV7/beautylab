...
export default function InvoicesPage() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans">
      ...
      {/* SIDEBAR LATERAl (Se oculta al imprimir) */}
      <aside className="w-64 bg-white border-r border-gray-200 hidden md:block print:hidden">
        <div className="p-6 flex items-center gap-2">
          <span className="text-red-500 font-bold text-2xl">&lt;/&gt;</span>
          <h1 className="text-2xl font-bold text-gray-800">Codyn</h1>
        </div>
        <nav className="mt-6">
          <ul>
            <li className="px-6 py-3 text-gray-600 hover:bg-gray-50 cursor-pointer flex items-center gap-3">
              <span>🏠</span> Dashboard
            </li>
            <li className="px-6 py-3 bg-red-500 text-white rounded-r-full mr-4 cursor-pointer flex items-center gap-3 shadow-sm">
              <span>📄</span> Invoices
            </li>
            <li className="px-6 py-3 text-gray-600 hover:bg-gray-50 cursor-pointer flex items-center gap-3">
              <span>📚</span> Courses

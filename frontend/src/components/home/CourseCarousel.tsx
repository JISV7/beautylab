    ...
    <section id="courses" className="py-16 lg:py-24 palette-background overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-h2 mb-4">Featured Courses</h2>
            ...
            <SwiperSlide key={course.id} className="h-full">
              <div className="h-full flex flex-col palette-surface palette-border border rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden group min-h-[500px]">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  {/* Course Content */}
                  <h3 className="text-h3 mb-3 line-clamp-2 min-h-[3.2rem]">
                    {course.title}
                  </h3>
                  ...
                  {/* Course Meta */}
                  <div className="flex items-center justify-between mb-6 text-paragraph">
                    <div className="flex items-center gap-2">
                      <Clock className="w-4 h-4 text-paragraph" />
                      <span className="text-h5">{course.duration}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Users className="w-4 h-4 text-paragraph" />
                      <span className="text-h5">{course.students}</span>
                    </div>
                  </div>

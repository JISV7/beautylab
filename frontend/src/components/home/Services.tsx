    ...
    <section id="services" className="py-16 lg:py-24 palette-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-subtitle text-subtitle text-subtitle text-subtitle mb-4">What We Offer</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            ...
            >
              ...
              <h3 className="text-subtitle text-subtitle text-subtitle text-subtitle mb-3">{service.title}</h3>
